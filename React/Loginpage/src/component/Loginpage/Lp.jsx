                    ...
                    <div className="left w-full m-2.5 rounded-2xl bg-blue-50-100">
                        <form>
                            ...
                            <div className="btn pt-4 flex justify-center items-center">
                                <button className="w-4/5 p-2.5 text-base bg-linear-to-r from-indigo-300 to-purple-800 rounded-2xl shadow-indigo-800 shadow-lg/50 text-white transition delay-100 duration-300 ease-in-out hover:-translate-y-1 hover:scale-100" type="submit">
                                    {/* <span>
