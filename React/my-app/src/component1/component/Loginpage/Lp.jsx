...
function Left() {
    ...
    return (
        <>
            <div className="flex p-18 py-30 mb-auto justify-center w-full h-full bg-[url('/Users/Lakshmi/Documents/GitHub/mern-april-26/React/my-app/src/component1/component/Loginpage/bgs.png')] bg-cover rounded-2xl ">
