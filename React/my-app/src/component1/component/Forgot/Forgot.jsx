...
function Forgot() {
    ...
    return (
        <>
            <div className="main p-18 py-35 ml-auto mr-auto flex justify-center w-full bg-[url('/Users/Lakshmi/Documents/GitHub/mern-april-26/React/my-app/src/component1/component/Loginpage/bg.jpg')] bg-cover rounded-2xl items-center ">
