...
function Skill() {
    ...
    //     desc: "Python"
    // }]);
    // const [skillPer, setSkillPer] = useState()
    // const [skillName, setSkillName] = useState("abncd")
    // const [showTech, setShowTec] = useState(true)
            ...
            <section id="Skill">
                <div className=" max-w-7xl ml-auto mr-auto text-center mt-28 pb-4">
                    ...
                    <div className="flex flex-row justify-around items-center pt-10">
                        <div className="flex flex-row justify-around items-center pt-10 w-full">
                            {
                                skillScore.map((skill, index) => {
                                    return (
                                        <div key={index}>
                                            <div className="circle">
                                                <div className="circle w-28 h-28 rounded-[50%] flex items-center justify-center relative bg-gray-300">
                                                    <div className={` circle w-28 h-28 rounded-[50%] flex items-center justify-center absolute bg-indigo-400 bg-[conic-gradient(#8190e3_calc(var(--percent)*1%),_#e0e0e0_0)]`} style={{ '--percent': skill.per }}></div>
                                                </div>
                    ...
                    <div className={`${color} flex flex-row justify-around items-center pt-10 w-full`}>
                        {
                            skills?.map((skill, index) => {
                                return (
                                    <div key={index}>
                                        <div className="circle">
                                            <div className="circle w-28 h-28 rounded-[50%] flex items-center justify-center relative bg-gray-300">
                                                <div className={`circle w-28 h-28 rounded-[50%] flex items-center justify-center absolute bg-[conic-gradient(#8190e3_calc(var(--percent)*1%),_#e0e0e0_0)]`} style={{ '--percent': skill.per }}></div>
                                            </div>
                                            <div className=" ml-3 mr-5 w-22 h-22 rounded-full bottom-25 relative text-center bg-white font-semibold text-xl">{skill.per}%<br></br><small className="font-semibold items-center text-base text-gray-600">{skill.desc}</small></div>
                                        </div>
                                    </div>
                        ...
                        {/* </div>
                    <input placeholder="per" onChange={(e)=>{
                        console.log(e)
