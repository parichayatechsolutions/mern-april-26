    ...
    return (
        ...
        <section id="skill">
            <div className="heading3">
                ...
                <div className="chart">
                    <div className="skill">
                        <div className="circle" style="--percent:90">
                            <span>90%<br></br><small>Python</small></span>
                        </div>
                    </div>

                    <div className="skill">
                        <div className="circle" style="--percent:80">
                            <span>80%<br></br><small>JavaScript</small></span>
                        </div>
                    </div>

                    <div className="skill">
                        <div className="circle" style="--percent:75">
                            <span>75%<br></br><small>React</small></span>
                        </div>
                    </div>

                    <div className="skill">
                        <div className="circle" style="--percent:70">
                            <span>70%<br></br><small>Node.js</small></span>
                        </div>
                    </div>
                </div>
                <div className="tt">
