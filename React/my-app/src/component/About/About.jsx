                ...
                <div className="about_sec ml-auto mr-auto max-w-7xl">
                    ...
                    <div className="third grid grid-cols-3 gap-9 box-border border-solid border-gray-300 pt-5">
                        <div className="heading2 grid col-span-2 box-border border-solid border-gray-300 ">
                            <div className="t_mid p-9 rounded-2xl bg-white box-border border-solid border-gray-300 shadow-lg/15 h-fit">
                                ...
                                <div className=" grid-cols-4 grid gap-6 pt-5">
                                    {
                                        scoreCard.map((card, index) => {
                                            return (
                                                <div key={index} className = "font-bold text-3xl leading-9 mb-2 bg-linear-to-r from-indigo-400 to-purple-800 text-center bg-clip-text text-transparent" > 
                                                {card.no1}
                                                </div>
                                ...
                                {/* <div className="per_1">
                                    <div className="font-bold text-3xl leading-9 mb-2 bg-linear-to-r from-indigo-400 to-purple-800 text-center bg-clip-text text-transparent">{per1}</div>
                                    <div className="text-gray-600 text-sm leading-5 text-center">{per2}</div>
                                </div>
                                <div className="per_2">
                                    <div className="font-bold text-3xl leading-9 mb-2 bg-linear-to-r from-indigo-400 to-purple-800 text-center bg-clip-text text-transparent">{per3}</div>
                                    <div className="text-gray-600 text-sm leading-5 text-center">{per4}</div>
                                </div>
                                <div className="per_3">
                                    <div className="font-bold text-3xl leading-9 mb-2 bg-linear-to-r from-indigo-400 to-purple-800 text-center bg-clip-text text-transparent">{per5}</div>
                                    <div className="text-gray-600 text-sm leading-5 text-center">{per6}</div>
                                </div>
                                <div className="per_4">
                                    <div className="font-bold text-3xl leading-9 mb-2 bg-linear-to-r from-indigo-400 to-purple-800 text-center bg-clip-text text-transparent">{per7}</div>
                                    <div className="text-gray-600 text-sm leading-5 text-center">{per8}</div>
                                </div> */}
                            </div>
                        </div>
                    </div>
                    <div className="th_r max-w-sm m-auto flex flex-col gap-6 w-full ">
                        <div className="edu bg-white p-6 rounded-2xl box-border border-solid border-gray-300 shadow-lg/15">
                            <div className="edu_s">
                                <span className=" w-14 h-14 flex items-center justify-center rounded-2xl text-white bg-linear-to-r from-indigo-400 to-purple-800"><svg xmlns="http://www.w3.org/2000/svg" fill="#ffffff" width="30px" height="30px"
                                    viewBox="0 0 32 32">
                                    <path
                            ...
                            <h3 className=" mt-5 text-xl text-black font-semibold">{ed}</h3>
                            <p className="text-lg text-gray-600 ">{ed1}<br></br></p>
                            <p className="text-lg text-gray-600">{ed2}<br></br></p>
                            <p className="text-lg text-gray-600">{ed3}</p>
                        </div>
                        ...
                        <div className="loc bg-white p-6 rounded-2xl box-border border-solid border-gray-300 shadow-lg/15">
                            <div className="loc_s">
                                <span className=" w-14 h-14 flex items-center justify-center rounded-2xl text-white bg-linear-to-r from-indigo-400 to-purple-800"><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
