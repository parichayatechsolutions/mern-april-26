        ...
        <section id="about">
            <div className="about_sec">
                <div className="heading1">
                    <h3> About Me </h3>
                    <p>Passionate engineer with a focus on creating efficient, scalable solutions.</p>
                </div>
                <div className="third">
                    <div className="heading2">
                        <div className="t_mid">
                            <h3>My Journey </h3>
                            <p>I'm a passionate 3rd-year Computer Engineering student who loves creating digital
                                solutions
                                that
                                make
                                a difference. My approach combines technical expertise with creative thinking to build
                                applications
                                that are both powerful and user-friendly.<br></br></p>
                            <p>Through my coursework and personal projects, I've developed a solid foundation in
                                programming,
                                data
                                structures, and software engineering principles. I'm currently seeking internship
                                opportunities
                                to
                                apply my skills in a professional environment and contribute to meaningful projects.</p>
                            <div className="per">
                                <div className="per_1">
                                    <div className="p tw">2</div>
                                    <div className="c tw">Projects</div>
                                </div>
                                <div className="per_2">
                                    <div className="p la">6+</div>
                                    <div className="c la">Languages</div>
                                </div>
                                <div className="per_3">
                                    <div className="p in">1</div>
                                    <div className="c in">Internships</div>
                                </div>
                                <div className="per_4">
                                    <div className="p cer">4</div>
                                    <div className="c cer">Certification</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="th_r">
                        <div className="edu">
                            ...
                            <h3>Education</h3>
                            <p>Master of Computer Applications<br></br></p>
                            <p>Mysore University | 2024-2026<br></br></p>
                            <p>CGPA: 8.3/10</p>
                        </div>
                        <div className="car">
                            <div className="car_s">
                            ...
                            <h3>Career Focus</h3>
                            <p>Software Development & AI<br></br></p>
                            <p>Seeking Internship and job<br></br></p>
                        </div>
                        <div className="loc">
                            <div className="loc_s">
                            ...
                            <h3>Location</h3>
                            <p>Vasantha Nagara,<br></br></p>
                            <p>Mysuru 570028<br></br></p>
                        </div>
                    </div>
                </div>
            </div>
