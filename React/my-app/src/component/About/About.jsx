...
function About() {
    ...
    return (
        < >
            ...
            <section id="about">
                <div className="about_sec ml-auto mr-auto max-w-7xl text-center">
                    ...
                    <div className="third grid grid-cols-3 gap-9 box-border border-solid border-gray-300 pt-5">
                        <div className="heading2 grid col-span-2 box-border border-solid border-gray-300">
                            <div className="t_mid p-9 rounded-2xl bg-white box-border border-solid border-gray-300">
                                <h3>{my}</h3>
                                <p>{para3}<br></br></p>
                                <p>{para4}</p>
                        ...
                        <div className="th_r max-w-sm m-auto flex flex-col gap-6 w-full ">
                            <div className="edu bg-white p-6 rounded-2xl box-border border-solid border-gray-300">
                                <div className="edu_s">
                            ...
                            <div className="car bg-white p-6 rounded-2xl box-border border-solid border-gray-300">
                                <div className="car_s">
                            ...
                            <div className="loc bg-white p-6 rounded-2xl box-border border-solid border-gray-300">
                                <div className="loc_s">
