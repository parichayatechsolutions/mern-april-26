            ...
            <div className="flex flex-col text-5 font-[cursive] font-bold pt-18 px-90">
                <div className="mb-2.5">
                    <div className="flex justify-between">
                        <span className="text-[20px] font-bold"><b>{program_name1}</b></span>
                        <span className="text-[20px] font-bold">{p_percentage}</span>
                    </div>
                ...
                <div className="mb-2.5">
                    <div className="flex justify-between">
                        <div className="text-[20px] font-bold"><b>{program_name2}</b></div>
                        <div className="text-[20px] font-bold">{js_perceentage}</div>
                    </div>
                    <div className="border border-solid border-black w-full h-5 rounded-2xl relative m-0">
                ...
                <div className="mb-2.5">
                    <div className="flex justify-between">
                        <div className="text-[20px] font-bold"><b>{pgrogram_name3}</b></div>
                        <div className="text-[20px] font-bold">{r_percentage}</div>
                    </div>
                    <div className="border border-solid border-black w-full h-5 rounded-2xl relative m-0">
                ...
                <div className="mb-2.5">
                    <div className="flex justify-between">
                        <div className="text-[20px] font-bold"><b>{program_name4}</b></div>
                        <div className="text-[20px] font-bold">{d_percentage}</div>
                    </div>
                    <div className="border border-solid border-black w-full h-5 rounded-2xl relative m-0">
